...
#秩序パラメータと補助変数の初期値設定　*続きからできるように分岐処理
q_init = np.array(np.ones(2))
r_init = np.ones(1)
...
#q, r, q_hat, r_hat = 
#saddle_point(beta, q, r, q_hat, r_hat)
#print(beta, q[0], q[1], r, q_hat[0], q_hat[1], r_hat)
